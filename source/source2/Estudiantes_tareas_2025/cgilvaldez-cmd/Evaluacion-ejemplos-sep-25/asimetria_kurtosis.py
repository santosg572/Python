# -*- coding: utf-8 -*-
"""
Created on Sat Sep 13 20:51:19 2025
...
def kurtosis(li=[]):
    ...
    sum = 0
    for x in li:
        sum = sum + (xk/((2.966486107676365)**4)-3)
    return sum/(n1)
...
print('La diferencia a cuarta potencia de x es', cuarta([36, 39, 35, 37, 36, 38, 39, 43, 41, 36, 36, 
      40, 36, 42, 43,  41, 42, 39, 36, 36, 43, 41, 36, 45, 38, 40, 37.5]))

print('La kurtosis de x es', kurtosis([36, 39, 35, 37, 36, 38, 39, 43, 41, 36, 36, 
      40, 36, 42, 43,  41, 42, 39, 36, 36, 43, 41, 36, 45, 38, 40, 37.5]))
